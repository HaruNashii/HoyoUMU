...
lazy_static! {
    pub static ref HOYOUMU_DIRS: [String; 7] = [format!("{}/.config/hoyoplay-umu", *HOME_DIR), format!("{}/.config/hoyoplay-umu/ProtonLatest", *HOME_DIR), format!("{}/.config/hoyoplay-umu/umu_config", *HOME_DIR), "icons".to_string(), format!("{}/.config/hoyoplay-umu/wine_prefix", *HOME_DIR), format!("{}/.local/share/applications", *HOME_DIR), format!("{}/.config/protonfixes/localfixes", *HOME_DIR)];
