use crate::{
    actions::buttons_actions::{ALL_DOWNLOAD_SUCCEEDED, DOWNLOADING_HOYOPLAY, DOWNLOADING_HOYOPLAY_SETUP, DOWNLOADING_OTHERS, DOWNLOADING_PROTON_GE, GITHUB_API_AVAILABLE, HOYOPLAY_DOWNLOAD_SUCCEEDED, LOADING, PROTON_DOWNLOAD_SUCCEEDED, PROTON_EXIST, PROTON_LATEST_EXIST, UMU_RUN_EXIST},
    ui::pages::{ButtonId, PageId, already_installed_pe, download_not_succeed_pe, download_not_succeed_proton_pe, download_succeed, downloading_pe, github_api_unavailabe_pe, loading, umu_run_dont_exist, using_local_proton}
};
