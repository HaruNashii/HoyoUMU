...
if [ ! -f "$hoyoplay_setup_path" ]; then
	...
	curl -sL https://sg-public-api.hoyoverse.com/event/download_porter/trace/hyp_global/hyphoyoverse/default --output "$hoyoplay_setup_path" > /dev/null 2>&1
else 
...
if [ ! -f "$icon_path" ]; then
	...
	sudo curl -sL https://act-webstatic.hoyoverse.com/puzzle/hyp/pz_Bur_m6Btc7/resource/puzzle/2024/10/21/b9992eaa38d4b36641accee82ede7bd3_3188319471762169697.png --output "$icon_path/hoyoplay_icon.png" > /dev/null 2>&1
else
